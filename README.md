...
Текущее состояние: с осени 2023года система используется клубом в Хельсинки. Нареканий не было. (Была механическая проблема с одной из кнопок - к описанию здесь напрямую не относится).
